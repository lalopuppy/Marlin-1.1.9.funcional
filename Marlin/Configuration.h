 ...
 */
//#define PIDTEMPBED  // Desactivarlo para que funcione la cama caliente con rele
...
#define Z_SERVO_ANGLES {137,50}  // Z Servo Deploy and Stow angles
 ...
 *    |  A-------D          |  A-------D          |  A-------D
 *    +-------------->X     +-------------->X     +-------------->Y
 *     XY_SKEW_FACTOR        X SKEW_FACTOR        YZ_SKEW_FACTOR
 */
...
#define SERVO_DELAY { 300, 300, 300, 300 } // poner tantos delays como servos
